...
public class Deposit {
    ...
    @Id
    private Long id;
    private TransactionType type; //enum serialize to string
    private String trasnaction_date;
    private TransactionStatus transaction_status; //enum serialize to string
    private String payee_id;
    private Medium medium; //enum serialize to string
    private String description;
    private Account account;

    public Deposit(){}

    public Deposit(Long id, TransactionType type, String trasnaction_date, TransactionStatus transaction_status, String payee_id, Medium medium, String description, Account account) {
        this.id = id;
        this.type = type;

...
public class Bill {
    ...
    public Bill(Long id, BillStatus status, String payee, String nickname, String creation_date, Integer payment_date, Integer recurring_date, String upcoming_payment_date, Double payment_amount, Account account) {
        this.id = id;
        this.status = status;
        this.payee = payee;
